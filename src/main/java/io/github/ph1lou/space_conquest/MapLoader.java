...
public class MapLoader {
    ...
    public void generateTeamCamp(){
        ...
        for (Team team:game.getTeams()) {
            ...
            NPC npc = CitizensAPI.getNPCRegistry().createNPC(EntityType.PLAYER, "Commandant Équipe "+team.getColorTeam().getChatColor()+team.getName());

            //npc.data().setPersistent(NPC.PLAYER_SKIN_TEXTURE_PROPERTIES_METADATA, "");
          //  npc.data().setPersistent(NPC.PLAYER_SKIN_TEXTURE_PROPERTIES_SIGN_METADATA, "");
